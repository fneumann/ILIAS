...
{
	$metadataSources[]= array('type' => 'xml', 'file' => $file);
}
// ilias-patch: end
/* 
...
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath'           => 'ilias/vhb/simplesaml/',
    'certdir' => 'cert/',
    'loggingdir'            => '/nfs/iliasdata/studon',
    'datadir' => 'data/',
     ...
     */
    'auth.adminpassword' => 'tzq3nKrwgjIyjRPFUPZo',
     ...
     */
    'secretsalt' => 'T4XI6kIZDeSJ1TuKmEKt',
     ...
     */
    'technicalcontact_name' => 'StudOn Administrator',
    'technicalcontact_email'    => 'studon@fau.de',
     ...
     */
    'logging.logfile' => 'simplesamlphp_ilias.log',
     ...
     */
    'session.cookie.name' => 'IliasSimpleSAMLSessionID',
     ...
     */
     // ilias-patch: begin
     'metadata.sources' => array (
	array('type' => 'flatfile', 'directory' => '/nfs/iliasdata/studon/repdata/StudOnIlias/auth/saml/metadata/')
	),
     // ilias-patch: end
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'mysql:host=10.76.13.8;dbname=simplesaml_ilias',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => "simplesaml",
    'store.sql.password' => "0k5OeidSH",

    /*
     * The prefix we should use on our tables.
     */
    'store.sql.prefix' => 'studon_ilias',
