...
/**
 * Extended Interface for extended assignment type.
 *
...
interface ilExAssignmentTypeExtendedGUIInterface extends ilExAssignmentTypeGUIInterface
{
    ...
    /**
     * Indicate that type provides an own implementation if the grading by assignment screen
     * @return bool
     */
    public function hasOwnGradingByAssignment() : bool;


    /**
     * Show the screen for grading by assignment
     * @param ilExAssignment $_assignment
     */
    public function showGradingByAssignment(ilExAssignment $_assignment);
     ...
     */
    public function modifyGradingActionItems(ilExSubmission $a_submission, ilAdvancedSelectionListGUI $a_actions);
}
